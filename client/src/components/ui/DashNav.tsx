...
const DashNav: React.FC<DashNavProps> = ({ userName, handleLogout, toggleFullLibrary, toggleDashboard }) => {
    ...
    return (
        <div className='border dark:border-white border-black border-opacity-15 dark:border-opacity-5 w-full h-[70px] bg-neutral-50 dark:bg-neutral-900 rounded-2xl p-[20px] flex justify-between items-center shadow-lg relative'>
