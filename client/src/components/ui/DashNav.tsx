...
const DashNav: React.FC<DashNavProps> = ({ userName, handleLogout, toggleFullLibrary, toggleDashboard, toggleProfile, toggleAssessment }) => {
        ...
        <div className='z-[500] border dark:border-white border-black border-opacity-15 dark:border-opacity-5 w-full h-[70px] bg-neutral-50 dark:bg-neutral-900 rounded-2xl p-[20px] flex justify-between items-center shadow-lg relative'>
            ...
            >
                ...
                <div className="py-1 flex flex-col gap-1">
                    ...
                    <button onClick={toggleProfile}  className="text-gray-700 dark:text-neutral-50 block px-4 py-2 text-sm hover:bg-neutral-100 dark:hover:bg-neutral-500 flex justify-start">Profile</button>
